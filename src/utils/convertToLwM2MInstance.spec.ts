...
void describe('convertToLwM2MInstance', () => {
	void it('should convert object using schema definition', () => {
		const schema = {
			type: 'object',
	...
	void it('should convert object event when input does not follow required values in the schema definition', () => {
		const schema = {
			type: 'object',
			$id: 'https://github.com/OpenMobileAlliance/lwm2m-registry/raw/prod/3.xml',
			title: 'Device',
	...
	void it('should convert object event when input does not follow data type of the schema definition', () => {
		const schema = {
			type: 'object',
			$id: 'https://github.com/OpenMobileAlliance/lwm2m-registry/raw/prod/3.xml',
			title: 'Device',
